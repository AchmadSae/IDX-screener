...
/**
 * POST /api/analyses — runs the rules engine + DeepSeek for an instrument
...
/**
 * GET /api/analyses?symbol=&assetClass=&limit= — recent AI analysis runs.
 */
